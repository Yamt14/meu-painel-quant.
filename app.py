...
# Estilização CSS para fundo Blackout e métricas no estilo limpo do QQQ
st.markdown("""
    <style>
        body { background-color: #0b0c10; color: white; }
        .block-container { padding-top: 1rem; padding-bottom: 0rem; }
        .metric-box { background-color: #111111; padding: 12px 15px; border-radius: 6px; border: 1px solid #222222; }
        .metric-title { color: #888888; font-size: 13px; font-weight: bold; margin-bottom: 4px; text-transform: uppercase; }
...
try:
    ...
    # --- TOPO REESTRUTURADO: Estilo moderno do QQQ aplicado ao formato MNQ ---
